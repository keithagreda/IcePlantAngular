...
export class CustomerService {
    ...
    getCustomerTrans(id: string | undefined, filterText: string | null | undefined, pageNumber: number | null | undefined, pageSize: number | null | undefined): Observable<ApiResponseOfPaginatedResultOfCustomerWithTransDto> {
        let url_ = this.baseUrl + "/api/Customer/GetCustomerTrans?";
        if (id === null)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetCustomerTrans(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetCustomerTrans(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<ApiResponseOfPaginatedResultOfCustomerWithTransDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<ApiResponseOfPaginatedResultOfCustomerWithTransDto>;
        }));
    }

    protected processGetCustomerTrans(response: HttpResponseBase): Observable<ApiResponseOfPaginatedResultOfCustomerWithTransDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = ApiResponseOfPaginatedResultOfCustomerWithTransDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
...
export class MachineService {
    ...
    getAllMachine(): Observable<ApiResponseOfListOfMachineDto> {
        let url_ = this.baseUrl + "/api/Machine/GetAllMachine";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetAllMachine(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetAllMachine(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<ApiResponseOfListOfMachineDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<ApiResponseOfListOfMachineDto>;
        }));
    }

    protected processGetAllMachine(response: HttpResponseBase): Observable<ApiResponseOfListOfMachineDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = ApiResponseOfListOfMachineDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
    ...
    createOrEdit(input: CreateOrEditMachineDto): Observable<ApiResponseOfString> {
        let url_ = this.baseUrl + "/api/Machine/CreateOrEditMachineDto";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processCreateOrEdit(response: HttpResponseBase): Observable<ApiResponseOfString> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    getForEdit(id: number): Observable<ApiResponseOfCreateOrEditMachineDto> {
        let url_ = this.baseUrl + "/api/Machine/GetForEdit/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<ApiResponseOfCreateOrEditMachineDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<ApiResponseOfCreateOrEditMachineDto>;
        }));
    }

    protected processGetForEdit(response: HttpResponseBase): Observable<ApiResponseOfCreateOrEditMachineDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = ApiResponseOfCreateOrEditMachineDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
    ...
    getMachineForDropdown(filterText: string | null | undefined, pageNumber: number | null | undefined, pageSize: number | null | undefined): Observable<ApiResponseOfPaginatedResultOfGetMachineForDropDown> {
        let url_ = this.baseUrl + "/api/Machine/GetMachineForDropdown?";
        if (filterText !== undefined && filterText !== null)
            url_ += "FilterText=" + encodeURIComponent("" + filterText) + "&";
        if (pageNumber !== undefined && pageNumber !== null)
            url_ += "PageNumber=" + encodeURIComponent("" + pageNumber) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetMachineForDropdown(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetMachineForDropdown(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<ApiResponseOfPaginatedResultOfGetMachineForDropDown>;
                }
            } else
                return _observableThrow(response_) as any as Observable<ApiResponseOfPaginatedResultOfGetMachineForDropDown>;
        }));
    }

    protected processGetMachineForDropdown(response: HttpResponseBase): Observable<ApiResponseOfPaginatedResultOfGetMachineForDropDown> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = ApiResponseOfPaginatedResultOfGetMachineForDropDown.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
...
export class MachineProductionService {
    ...
    getAllMachineGeneration(minCreationTime: Date | null | undefined, maxCreationTime: Date | null | undefined, filterText: string | null | undefined, pageNumber: number | null | undefined, pageSize: number | null | undefined): Observable<ApiResponseOfGetMachineGenerationWTotal> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetAllMachineGeneration(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
...
export class NotificationService {
    ...
    sendMessageToAdmin(message: string | undefined): Observable<ApiResponseOfString> {
        let url_ = this.baseUrl + "/api/Notification/SendMessageToAdmin?";
        if (message === null)
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processSendMessageToAdmin(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processSendMessageToAdmin(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<ApiResponseOfString>;
                }
            } else
    ...
    protected processSendMessageToAdmin(response: HttpResponseBase): Observable<ApiResponseOfString> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class PrinterLogsService {
    ...
    createPrinterLogs(transNum: string | undefined): Observable<ApiResponseOfBoolean> {
        let url_ = this.baseUrl + "/api/PrinterLogs/CreatePrinterLogs?";
        if (transNum === null)
            throw new Error("The parameter 'transNum' cannot be null.");
        else if (transNum !== undefined)
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCreatePrinterLogs(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCreatePrinterLogs(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<ApiResponseOfBoolean>;
                }
            } else
                return _observableThrow(response_) as any as Observable<ApiResponseOfBoolean>;
        }));
    }

    protected processCreatePrinterLogs(response: HttpResponseBase): Observable<ApiResponseOfBoolean> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    getPrinterLogs(transNum: string | undefined): Observable<ApiResponseOfInteger> {
        let url_ = this.baseUrl + "/api/PrinterLogs/GetPrinterLogs?";
        if (transNum === null)
            throw new Error("The parameter 'transNum' cannot be null.");
        else if (transNum !== undefined)
            url_ += "transNum=" + encodeURIComponent("" + transNum) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetPrinterLogs(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetPrinterLogs(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<ApiResponseOfInteger>;
                }
            } else
                return _observableThrow(response_) as any as Observable<ApiResponseOfInteger>;
        }));
    }

    protected processGetPrinterLogs(response: HttpResponseBase): Observable<ApiResponseOfInteger> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = ApiResponseOfInteger.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
...
export class ProductCostService {
    ...
    getAll(isActive: boolean | null | undefined, filterText: string | null | undefined, pageNumber: number | null | undefined, pageSize: number | null | undefined): Observable<ApiResponseOfPaginatedResultOfProductCostDto> {
        let url_ = this.baseUrl + "/api/ProductCost/GetAll?";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<ApiResponseOfPaginatedResultOfProductCostDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<ApiResponseOfPaginatedResultOfProductCostDto>;
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<ApiResponseOfPaginatedResultOfProductCostDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = ApiResponseOfPaginatedResultOfProductCostDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
...
export class SalesService {
    ...
    voidSales(id: string | undefined): Observable<ApiResponseOfString> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processVoidSales(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processVoidSales(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<ApiResponseOfString>;
                }
            } else
...
export class ApiResponseOfPaginatedResultOfCustomerWithTransDto implements IApiResponseOfPaginatedResultOfCustomerWithTransDto {
    data!: PaginatedResultOfCustomerWithTransDto;
    message?: string;
    isSuccess?: boolean;
    errors?: string[];

    constructor(data?: IApiResponseOfPaginatedResultOfCustomerWithTransDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (!data) {
            this.data = new PaginatedResultOfCustomerWithTransDto();
        }
    }

    init(_data?: any) {
        if (_data) {
            this.data = _data["data"] ? PaginatedResultOfCustomerWithTransDto.fromJS(_data["data"]) : new PaginatedResultOfCustomerWithTransDto();
            this.message = _data["message"] !== undefined ? _data["message"] : <any>null;
            this.isSuccess = _data["isSuccess"] !== undefined ? _data["isSuccess"] : <any>null;
            if (Array.isArray(_data["errors"])) {
                this.errors = [] as any;
    ...
    static fromJS(data: any): ApiResponseOfPaginatedResultOfCustomerWithTransDto {
        data = typeof data === 'object' ? data : {};
        let result = new ApiResponseOfPaginatedResultOfCustomerWithTransDto();
        result.init(data);
        return result;
    }
...
export interface IApiResponseOfPaginatedResultOfCustomerWithTransDto {
    data: PaginatedResultOfCustomerWithTransDto;
    message?: string;
    isSuccess?: boolean;
    errors?: string[];
...
export class PaginatedResultOfCustomerWithTransDto implements IPaginatedResultOfCustomerWithTransDto {
    items?: CustomerWithTransDto[];
    totalCount?: number;
    totalPages?: number;
    currentPage?: number;
    pageSize?: number;

    constructor(data?: IPaginatedResultOfCustomerWithTransDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            if (Array.isArray(_data["items"])) {
                this.items = [] as any;
                for (let item of _data["items"])
                    this.items!.push(CustomerWithTransDto.fromJS(item));
            }
            else {
                this.items = <any>null;
            }
    ...
    static fromJS(data: any): PaginatedResultOfCustomerWithTransDto {
        data = typeof data === 'object' ? data : {};
        let result = new PaginatedResultOfCustomerWithTransDto();
        result.init(data);
        return result;
    }
...
export interface IPaginatedResultOfCustomerWithTransDto {
    items?: CustomerWithTransDto[];
    totalCount?: number;
    totalPages?: number;
    currentPage?: number;
...
export class CustomerWithTransDto implements ICustomerWithTransDto {
    id?: string;
    transNum?: string;
    balance?: number;
    totalAmount?: number;
    ...
    constructor(data?: ICustomerWithTransDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CustomerWithTransDto {
        data = typeof data === 'object' ? data : {};
        let result = new CustomerWithTransDto();
        result.init(data);
        return result;
    }
...
export interface ICustomerWithTransDto {
    id?: string;
    transNum?: string;
    balance?: number;
    totalAmount?: number;
...
export class ApiResponseOfListOfMachineDto implements IApiResponseOfListOfMachineDto {
    ...
    constructor(data?: IApiResponseOfListOfMachineDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            if (Array.isArray(_data["data"])) {
                this.data = [] as any;
                for (let item of _data["data"])
                    this.data!.push(MachineDto.fromJS(item));
            }
            else {
                this.data = <any>null;
            }
    ...
    static fromJS(data: any): ApiResponseOfListOfMachineDto {
        data = typeof data === 'object' ? data : {};
        let result = new ApiResponseOfListOfMachineDto();
        result.init(data);
        return result;
    }
...
export interface IApiResponseOfListOfMachineDto {
    data: MachineDto[];
    message?: string;
    isSuccess?: boolean;
    errors?: string[];
...
export class ApiResponseOfCreateOrEditMachineDto implements IApiResponseOfCreateOrEditMachineDto {
    data!: CreateOrEditMachineDto;
    message?: string;
    isSuccess?: boolean;
    errors?: string[];

    constructor(data?: IApiResponseOfCreateOrEditMachineDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (!data) {
            this.data = new CreateOrEditMachineDto();
        }
    }

    init(_data?: any) {
        if (_data) {
            this.data = _data["data"] ? CreateOrEditMachineDto.fromJS(_data["data"]) : new CreateOrEditMachineDto();
            this.message = _data["message"] !== undefined ? _data["message"] : <any>null;
            this.isSuccess = _data["isSuccess"] !== undefined ? _data["isSuccess"] : <any>null;
            if (Array.isArray(_data["errors"])) {
                this.errors = [] as any;
    ...
    static fromJS(data: any): ApiResponseOfCreateOrEditMachineDto {
        data = typeof data === 'object' ? data : {};
        let result = new ApiResponseOfCreateOrEditMachineDto();
        result.init(data);
        return result;
    }
...
export interface IApiResponseOfCreateOrEditMachineDto {
    data: CreateOrEditMachineDto;
    message?: string;
    isSuccess?: boolean;
    errors?: string[];
...
export class ApiResponseOfPaginatedResultOfGetMachineForDropDown implements IApiResponseOfPaginatedResultOfGetMachineForDropDown {
    data!: PaginatedResultOfGetMachineForDropDown;
    message?: string;
    isSuccess?: boolean;
    errors?: string[];

    constructor(data?: IApiResponseOfPaginatedResultOfGetMachineForDropDown) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (!data) {
            this.data = new PaginatedResultOfGetMachineForDropDown();
        }
    }

    init(_data?: any) {
        if (_data) {
            this.data = _data["data"] ? PaginatedResultOfGetMachineForDropDown.fromJS(_data["data"]) : new PaginatedResultOfGetMachineForDropDown();
            this.message = _data["message"] !== undefined ? _data["message"] : <any>null;
            this.isSuccess = _data["isSuccess"] !== undefined ? _data["isSuccess"] : <any>null;
            if (Array.isArray(_data["errors"])) {
                this.errors = [] as any;
    ...
    static fromJS(data: any): ApiResponseOfPaginatedResultOfGetMachineForDropDown {
        data = typeof data === 'object' ? data : {};
        let result = new ApiResponseOfPaginatedResultOfGetMachineForDropDown();
        result.init(data);
        return result;
    }
...
export interface IApiResponseOfPaginatedResultOfGetMachineForDropDown {
    data: PaginatedResultOfGetMachineForDropDown;
    message?: string;
    isSuccess?: boolean;
    errors?: string[];
...
export class PaginatedResultOfGetMachineForDropDown implements IPaginatedResultOfGetMachineForDropDown {
    ...
    constructor(data?: IPaginatedResultOfGetMachineForDropDown) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            if (Array.isArray(_data["items"])) {
                this.items = [] as any;
                for (let item of _data["items"])
                    this.items!.push(GetMachineForDropDown.fromJS(item));
            }
            else {
                this.items = <any>null;
            }
    ...
    static fromJS(data: any): PaginatedResultOfGetMachineForDropDown {
        data = typeof data === 'object' ? data : {};
        let result = new PaginatedResultOfGetMachineForDropDown();
        result.init(data);
        return result;
    }
...
export interface IPaginatedResultOfGetMachineForDropDown {
    items?: GetMachineForDropDown[];
    totalCount?: number;
    totalPages?: number;
    currentPage?: number;
...
export class GetMachineForDropDown implements IGetMachineForDropDown {
    id?: number;
    description?: string;

    constructor(data?: IGetMachineForDropDown) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): GetMachineForDropDown {
        data = typeof data === 'object' ? data : {};
        let result = new GetMachineForDropDown();
        result.init(data);
        return result;
    }
...
export interface IGetMachineForDropDown {
    id?: number;
    description?: string;
}
...
export class ApiResponseOfInteger implements IApiResponseOfInteger {
    data!: number;
    message?: string;
    isSuccess?: boolean;
    errors?: string[];

    constructor(data?: IApiResponseOfInteger) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): ApiResponseOfInteger {
        data = typeof data === 'object' ? data : {};
        let result = new ApiResponseOfInteger();
        result.init(data);
        return result;
    }
...
export interface IApiResponseOfInteger {
    data: number;
    message?: string;
    isSuccess?: boolean;
    errors?: string[];
...
export class ApiResponseOfPaginatedResultOfProductCostDto implements IApiResponseOfPaginatedResultOfProductCostDto {
    data!: PaginatedResultOfProductCostDto;
    message?: string;
    isSuccess?: boolean;
    errors?: string[];

    constructor(data?: IApiResponseOfPaginatedResultOfProductCostDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (!data) {
            this.data = new PaginatedResultOfProductCostDto();
        }
    }

    init(_data?: any) {
        if (_data) {
            this.data = _data["data"] ? PaginatedResultOfProductCostDto.fromJS(_data["data"]) : new PaginatedResultOfProductCostDto();
            this.message = _data["message"] !== undefined ? _data["message"] : <any>null;
            this.isSuccess = _data["isSuccess"] !== undefined ? _data["isSuccess"] : <any>null;
            if (Array.isArray(_data["errors"])) {
                this.errors = [] as any;
    ...
    static fromJS(data: any): ApiResponseOfPaginatedResultOfProductCostDto {
        data = typeof data === 'object' ? data : {};
        let result = new ApiResponseOfPaginatedResultOfProductCostDto();
        result.init(data);
        return result;
    }
...
export interface IApiResponseOfPaginatedResultOfProductCostDto {
    data: PaginatedResultOfProductCostDto;
    message?: string;
    isSuccess?: boolean;
    errors?: string[];
...
export class PaginatedResultOfProductCostDto implements IPaginatedResultOfProductCostDto {
    ...
    constructor(data?: IPaginatedResultOfProductCostDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            if (Array.isArray(_data["items"])) {
                this.items = [] as any;
                for (let item of _data["items"])
                    this.items!.push(ProductCostDto.fromJS(item));
            }
            else {
                this.items = <any>null;
            }
    ...
    static fromJS(data: any): PaginatedResultOfProductCostDto {
        data = typeof data === 'object' ? data : {};
        let result = new PaginatedResultOfProductCostDto();
        result.init(data);
        return result;
    }
...
export interface IPaginatedResultOfProductCostDto {
    items?: ProductCostDto[];
    totalCount?: number;
    totalPages?: number;
    currentPage?: number;
...
export class ProductCostDto implements IProductCostDto {
    id?: number;
    name?: string;
    amount?: number;
    isActive?: boolean;
    ...
    constructor(data?: IProductCostDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): ProductCostDto {
        data = typeof data === 'object' ? data : {};
        let result = new ProductCostDto();
        result.init(data);
        return result;
    }
...
export interface IProductCostDto {
    id?: number;
    name?: string;
    amount?: number;
    isActive?: boolean;
...
export class CreateOrEditProductCostDto implements ICreateOrEditProductCostDto {
    ...
    constructor(data?: ICreateOrEditProductCostDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateOrEditProductCostDto {
        data = typeof data === 'object' ? data : {};
        let result = new CreateOrEditProductCostDto();
        result.init(data);
        return result;
    }
...
export interface ICreateOrEditProductCostDto {
    id?: number | null;
    name?: string;
    amount?: number;
    productId?: number;
...
export class CreateStocksReceivingDto implements ICreateStocksReceivingDto {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.machineId = _data["machineId"] !== undefined ? _data["machineId"] : <any>null;
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["machineId"] = this.machineId !== undefined ? this.machineId : <any>null;
        return data;
    }
}
